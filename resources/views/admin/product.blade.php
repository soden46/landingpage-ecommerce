            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="center">
                        ...
                        <form action="{{ url('add_product_item') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="discount_price" class="form-control" id="discountPrice">
                            </div>
                            <div class="form-group">
                                <label for="product_quantity">productQuantity</label>
                                <input type="text" name="product_quantity" class="form-control" id="productQuantity">
                            </div>
